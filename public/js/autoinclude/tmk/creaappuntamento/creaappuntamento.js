        ...
        function (DataService, $scope, $rootScope, $timeout, Common, Tsnw) {
                ...
                DataService.getData("getCommerciali", {}, "getCommercialiPerformed", {},
                        function (t) {
                            ...
                            for (var i in t[1].response.data) {
                                that.vendors.push(t[1].response.data[i].NOME + " " + t[1].response.data[i].COGNOME)
                            }

                        },
                        function (t) {
                            alert("Attenzione qualcosa é andato storto nel recupero delle informazioni dei consulenti commerciali. Meglio ricaricare la pagina e riprovare.");
                        });
            ...
            this.registerNewAccount = function () {
                ...
                var account_vm = {
                    ...
                    venditore: that.newApp.commerciale,
                    telemarketing: ($scope.user.nome + " " + $scope.user.cognome)
                };
                that.registeringAcc = true;
