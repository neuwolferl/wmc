            ...
            function ($parse, $rootScope) {
                return function (scope, element, attrs) {
                    ...
                    element.bind("dragstart", function (e) {
                        if (attrs.ods) {
                            var ods = attrs.ods;
                            if (scope[ods] && angular.isFunction(scope[ods])) {
                                (scope[ods])();
                            }
                            else if (scope.$parent[ods] && angular.isFunction(scope.$parent[ods])) {
                                (scope.$parent[ods])();
                            }
                        }
                    ...
                    element.bind("dragend", function (e) {
                        if (attrs.ode) {
                            var ode = attrs.ode;
                            if (scope[ode] && angular.isFunction(scope[ode])) {
                                (scope[ode])();
                            }
                            else if (scope.$parent[ode] && angular.isFunction(scope.$parent[ode])) {
                                (scope.$parent[ode])();
                            }
                        }
                        var sendChannel = attrs.dragChannel || "defaultchannel";
