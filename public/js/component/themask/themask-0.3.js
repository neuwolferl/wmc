...
var app = angular.module("THEMASK", ['SMARTBUTTON'], ['$interpolateProvider',function ($interpolateProvider) {
    $interpolateProvider.startSymbol("--__");
    $interpolateProvider.endSymbol("__--");
}]);
app.directive('maschera', ['TheMask','SmartButton', function (TheMask, SmartButton) {
        var version = "0.3";
        return {
            templateUrl: function () {
                var baseurl = document.URL;
                baseurl = baseurl.split("public");
                return baseurl[0] + "public/js/component/themask/themask-" + version + ".html";
            },
            restrict: 'E',
            transclude: true,
            replace: true,
            ...
            controller: ['$scope', '$element', '$attrs', '$rootScope', '$timeout', 'TheMask', 'SmartButton', '$interval',
                function ($scope, $element, $attrs, $rootScope, $timeout, TheMask, SmartButton, $interval) {
...
app.provider("TheMask", function () {
    ...
    this.lock = false;
    this.hash = [];
    this.$get = ['$filter', '$rootScope', 'SmartButton',function ($filter, $rootScope, SmartButton) {
        var that = this;
        return {
