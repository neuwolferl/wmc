(function() {
    var app = angular.module('ProgettiDaAssegnare', [], function($interpolateProvider) {
    ...
    app.filter('situazioneprogetto', function() {
        return function(input) {
            if (input === "prospecting") {
                return "Da assegnare"
            }
            else if (input === "initiated") {
                return "Assegnato, non avviato"
            }
            return "";
        };
    });
    app.controller("ListoneController", function($scope, $http, $timeout) {
        ...
        this.linkURL = this.linkURL.split("progetti_da_assegnare");
        this.linkURL = this.linkURL[0] + "assegnazione/";
